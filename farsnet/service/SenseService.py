...
class SenseService(object):
        ...
        for row in cur:
            results.append(
                farsnet.schema.Sense(
                    ...
                    self._get_adj_type_sademorakkab(row["adj_type_sademorakkab"]),
                    row["vIssababi"],
                    row["vIsIdiom"],
    ...
    def _get_verb_tansivity(self, value):
        if value == None or value == "" or value == "Nothing":
            return ""
        return {
            "dovajhi": "Causative/Anticausative",
    ...
    def _get_verb_activity(self, value):
        if value == None or value == "" or value == "Nothing":
            return ""
        return {"active": "Active", "passive": "Passive"}.get(value, value)
    ...
    def _get_adad(self, value):
        if value == None or value == "" or value == "Nothing":
            return ""
        return {"asli": "Cardinal", "tartibi": "Ordinal"}.get(value, value)
