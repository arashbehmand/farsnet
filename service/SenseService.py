#!/usr/bin/env python
""" generated source for module SenseService """
# 
...
class SenseService(object):
    """ generated source for class SenseService """
    @classmethod
    def getSensesByWord(cls, searchStyle, searchKeyword):
        """ generated source for method getSensesByWord """
        results = ArrayList()
        ...
        try:
            while rs.next():
                results.add(Sense(rs.getInt("id"), rs.getString("seqId"), rs.getString("pos"), rs.getString("defaultValue"), rs.getInt("wordId"), rs.getString("avaInfo"), SenseService.getVtansivity(rs.getString("vtansivity")), SenseService.getVactivity(rs.getString("vactivity")), SenseService.getVtype(rs.getString("vtype")), SenseService.getNormalValue(rs.getString("synset")), SenseService.getNormalValue(rs.getString("vpastStem")), SenseService.getNormalValue(rs.getString("vpresentStem")), SenseService.getCategory(rs.getString("category")), SenseService.getGoupOrMokassar(rs.getString("goupOrMokassar")), SenseService.getEsmeZamir(rs.getString("esmeZamir")), SenseService.getAdad(rs.getString("adad")), SenseService.getAdverbType1(rs.getString("adverb_type_1")), SenseService.getAdverbType2(rs.getString("adverb_type_2")), SenseService.getAdjPishinVijegi(rs.getString("adj_pishin_vijegi")), SenseService.getAdjType(rs.getString("adj_type")), SenseService.getNoeKhas(rs.getString("noe_khas")), SenseService.getNounType(rs.getString("nounType")), SenseService.getAdjTypeSademorakkab(rs.getString("adj_type_sademorakkab")), rs.getBoolean("vIssababi"), rs.getBoolean("vIsIdiom"), SenseService.getVGozaraType(rs.getString("vGozaraType")), rs.getBoolean("kootah_nevesht"), rs.getBoolean("mohavere")))
    ...
    def getSensesBySynset(cls, synsetId):
        """ generated source for method getSensesBySynset """
        results = ArrayList()
    ...
    def getSenseById(cls, senseId):
        """ generated source for method getSenseById """
        result = None
    ...
    def getAllSenses(cls):
        """ generated source for method getAllSenses """
        results = ArrayList()
    ...
    def getSenseRelationsById(cls, senseId):
        """ generated source for method getSenseRelationsById """
        results = ArrayList()
        sql = "SELECT id, type, sense, sense2, senseWord1, senseWord2 FROM sense_relation WHERE sense = " + senseId + " OR sense2 = " + senseId
        try:
            while rs.next():
                results.add(SenseRelation(rs.getInt("id"), rs.getInt("sense"), rs.getInt("sense2"), rs.getString("senseWord1"), rs.getString("senseWord2"), rs.getString("type")))
        except SQLException as e:
            e.printStackTrace()
    ...
    def getSenseRelationsByType(cls, senseId, types):
        """ generated source for method getSenseRelationsByType """
        results = ArrayList()
        _types = ""
        _revTypes = ""
        for type_ in types:
            _types = String.valueOf(_types) + "'" + SenseService.RelationValue(type_) + "',"
            _revTypes = String.valueOf(_revTypes) + "'" + SenseService.RelationValue(SenseService.ReverseRelationType(type_)) + "',"
        _types = String.valueOf(_types) + "'not_type'"
        _revTypes = String.valueOf(_revTypes) + "'not_type'"
        sql = "SELECT id, type, sense, sense2, senseWord1, senseWord2 FROM sense_relation WHERE (sense = " + senseId + " AND type in (" + _types + ")) OR (sense2 = " + senseId + " AND type in (" + _revTypes + "))" + " ORDER BY sense"
        try:
            while rs.next():
                results.add(SenseRelation(rs.getInt("id"), rs.getInt("sense"), rs.getInt("sense2"), rs.getString("senseWord1"), rs.getString("senseWord2"), rs.getString("type")))
        except SQLException as e:
    ...
    def getPhoneticFormsByWord(cls, wordId):
        """ generated source for method getPhoneticFormsByWord """
        results = ArrayList()
    ...
    def getWrittenFormsByWord(cls, wordId):
        """ generated source for method getWrittenFormsByWord """
        results = ArrayList()
    ...
    def getVtansivity(cls, value):
        """ generated source for method getVtansivity """
    ...
    def getVactivity(cls, value):
        """ generated source for method getVactivity """
        if value == None or value == "" or value == "Nothing":
            return ""
        string = value
    ...
    def getVtype(cls, value):
        """ generated source for method getVtype """
        if value == None or value == "" or value == "Nothing":
            return ""
        string = value
    ...
    def getGoupOrMokassar(cls, value):
        """ generated source for method getGoupOrMokassar """
        if value == None or value == "" or value == "Nothing":
            return ""
        string = value
    ...
    def getEsmeZamir(cls, value):
        """ generated source for method getEsmeZamir """
        if value == None or value == "" or value == "Nothing":
            return ""
        string = value
    ...
    def getAdad(cls, value):
        """ generated source for method getAdad """
        if value == None or value == "" or value == "Nothing":
            return ""
        string = value
    ...
    def getNormalValue(cls, value):
        """ generated source for method getNormalValue """
        if value == None or value == "" or value == "Nothing":
            return ""
        return value
    ...
    def getAdjPishinVijegi(cls, value):
        """ generated source for method getAdjPishinVijegi """
    ...
    def getAdjType(cls, value):
        """ generated source for method getAdjType """
        if value == None or value == "" or value == "Nothing" or value == "No":
            return ""
        string = value
    ...
    def getNoeKhas(cls, value):
        """ generated source for method getNoeKhas """
        if value == None or value == "" or value == "Nothing" or value == "No":
            return ""
        string = value
    ...
    def getAdjTypeSademorakkab(cls, value):
        """ generated source for method getAdjTypeSademorakkab """
        if value == None or value == "" or value == "Nothing" or value == "No":
            return ""
        string = value
    ...
    def getVGozaraType(cls, value):
        """ generated source for method getVGozaraType """
        if value == None or value == "" or value == "Nothing":
            return ""
        res = " "
        if value.charAt(0)=='1':
    ...
    def ReverseSRelationType(cls, type_):
        """ generated source for method ReverseSRelationType """
        if type_ == "Refer-to":
